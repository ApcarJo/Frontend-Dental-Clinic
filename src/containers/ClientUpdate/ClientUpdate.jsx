...
const ClientUpdate = (props) => {
  ...
  const updatePassword = async () => {
    try {
      ...
      let res = await axios.put(
        "https://backclinic1.herokuapp.com/clients/updatepassword",
        body,
        { headers: { authorization: "Bearer " + token } }
      );
      setTimeout(() => {
        ...
        <div className="updateContainer">
          ...
          <form className="form">
            <input
              type="text"
              name="name"
              placeholder={props.credentials?.client.name}
          ...
          <form className="form">
            <input
              type="email"
              name="email"
              placeholder={props.credentials?.client.email}
              onChange={updateInfoClient}
          ...
          <form className="form">
            <input
              type="text"
              name="phone"
              placeholder={props.credentials?.client.phone}
              onChange={updateInfoClient}
          ...
          <form className="form">
            <input
              type="text"
              name="city"
              placeholder={props.credentials?.client.city}
              onChange={updateInfoClient}
          ...
          <form className="form">
            <input
              type="text"
              name="cp"
              placeholder={props.credentials?.client.cp}
              onChange={updateInfoClient}
